        ...
        if (c && b) {
            ...
            for (var g = b.next(); !g.done; g = b.next()) {
                ...
                g &&
                    ...
                    ((a.strokeStyle = y(d.color, { index: f, from: g, to: k })), (a.lineWidth = y(d.lineWidth, { index: f, from: g, to: k })), a.moveTo(g.x * e.width, g.y * e.height), a.lineTo(k.x * e.width, k.y * e.height));
                ++f;
                a.stroke();
            }
            a.restore();
