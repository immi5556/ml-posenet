...
import './tf-backend-webgpu.js';

import * as mpPose from './mediapipe-pose.js';
import * as tfjsWasm from './tf-backend-wasm.js';
import * as tf from './tf.min.js';

tfjsWasm.setWasmPaths(
    `https://cdn.jsdelivr.net/npm/@tensorflow/tfjs-backend-wasm@${tfjsWasm.version_wasm}/dist/`);

import * as posedetection from './tensorflow-models_pose-detection.js';

import { Camera } from './camera.js';
import { RendererWebGPU } from './renderer_webgpu.js';
